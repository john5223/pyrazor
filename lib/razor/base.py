...
from razor.exceptions import NotFound
...
class Manager(object):
    """
    Managers interact with a particular type of API (nodes, active_models, policies, etc.) and provide CRUD operations for them.
    """
    resource_class = None
